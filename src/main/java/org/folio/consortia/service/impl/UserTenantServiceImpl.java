...
public class UserTenantServiceImpl implements UserTenantService {
  ...
  public UserTenant getById(UUID id) {
    ...
    return entityToDto(userTenantEntity.get());
  }


  public UserTenant entityToDto(UserTenantEntity userTenantEntity) {
    var dto = new org.folio.pv.domain.dto.UserTenant();

    dto.setUserId(userTenantEntity.getUserId());
    dto.setTenantId(userTenantEntity.getTenantId());
    dto.setUsername(userTenantEntity.getUsername());
    dto.setIsPrimary(userTenantEntity.getIsPrimary());
